...
Need to tidy up the order of a lot of frames? Use the top menu option **Organize > Sort Frames by Filename** to instantly arrange the grid based on the original file names.
